-- Active: 1731844374261@@127.0.0.1@3306
...
BEGIN
    ...
    VALUES
        ...
        (NEW.id, 'Médico', 'fi-ss-user-md'),
        (NEW.id, 'Animal - Cão', 'fi-sr-dog-leashed'),
        (NEW.id, 'Animal - Brinquedos', 'fi-ss-bone'),
        (NEW.id, 'Animal - Gato', 'fi-sr-cat'),
        (NEW.id, 'Computador', 'fi-ss-devices'),
