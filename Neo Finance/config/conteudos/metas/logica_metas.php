...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['depositar'])) {
  ...
  // Converter o valor de depósito de volta para um número decimal
  $depositValue = str_replace(',', '.', str_replace('.', '', $depositValue));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['resgatar'])) {
  ...
  // Converter o valor de resgate de volta para um número decimal
  $withdrawValue = str_replace(',', '.', str_replace('.', '', $withdrawValue));
