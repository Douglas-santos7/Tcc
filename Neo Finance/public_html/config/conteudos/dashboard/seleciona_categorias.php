...
function obterCategorias($conn, $usuario_id)
{
    // Seleciona id, nome e icone onde excluida é false e usuario_id é igual ao usuário logado
    $sql = "SELECT id, nome, icone FROM categorias WHERE excluida = FALSE AND usuario_id = ?";
